...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_json_formatter_js__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filters_js__ = __webpack_require__(3);
...
function updateState(state, props) {
  ...
  const stateFormatter = new __WEBPACK_IMPORTED_MODULE_0_json_formatter_js___default.a(state, 1, {
  ...
  // props
  const propsFomatter = new __WEBPACK_IMPORTED_MODULE_0_json_formatter_js___default.a(props, 1, {
    hoverPreviewEnabled: false,
...
function draw() {
  ...
  let data = __WEBPACK_IMPORTED_MODULE_1__data_js__["a" /* default */]
  if (hideRedux) data = Object(__WEBPACK_IMPORTED_MODULE_2__filters_js__["b" /* filterRedux */])(data)
  if (hideDOM) data = Object(__WEBPACK_IMPORTED_MODULE_2__filters_js__["a" /* filterDOM */])(data)
  if (hideRouter) data = Object(__WEBPACK_IMPORTED_MODULE_2__filters_js__["c" /* filterRouter */])(data)
  drawChart(data)
}
...
draw(__WEBPACK_IMPORTED_MODULE_1__data_js__["a" /* default */])
...
const allData =
  ...
  /* harmony default export */ __webpack_exports__["a"] = (allData);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = filterRedux;
/* harmony export (immutable) */ __webpack_exports__["c"] = filterRouter;
/* harmony export (immutable) */ __webpack_exports__["a"] = filterDOM;
