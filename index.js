...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const draw = () => {
    ...
    if (hideDOM && hideRedux && hideRouter) drawChart(datas.noRouterReduxDOM)
    else if (hideDOM && hideRedux) drawChart(datas.noReduxDOM)
    else if (hideDOM && hideRouter) drawChart(datas.noRouterDOM)
    else if (hideRouter && hideRedux) drawChart(datas.noRouterRedux)
    else if (hideDOM) drawChart(datas.noDOM)
    else if (hideRedux) drawChart(datas.noRedux)
    else if (hideRouter) drawChart(datas.noRouter)
  ...
  function drawChart(treeData) {
    console.log('# drawChart  treeData: ', treeData)
